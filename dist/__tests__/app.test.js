...
describe("DELETE /api/quizzes/:quiz_id", () => {
    ...
    it("204: should delete the quiz along with the associated comments, likes, questions and answers", () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(app_1.default)
        ...
        const { rows } = yield connection_1.default.query(questionsQuery);
        const answersQuery = `
    SELECT * FROM answers 
    WHERE question_id IN (SELECT question_id FROM questions WHERE quiz_id = 1)
    `;
        const answersResponse = yield connection_1.default.query(answersQuery);
        const commentWithLikes = `
    SELECT * FROM likes WHERE content_id = 3 AND content_type = 'comment';
    `;
        const likeValues = yield connection_1.default.query(commentWithLikes);
    ...
    it("403: should respond with a msg if the user tries to delete a quiz they did not post", () => __awaiter(void 0, void 0, void 0, function* () {
        const { body: { msg }, } = yield (0, supertest_1.default)(app_1.default)
...
describe("DELETE /api/comments/:comment_id", () => {
    ...
    it("204: should delete the comment specified along with the associated likes", () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(app_1.default)
        ...
        const patchCommentRequest = yield (0, supertest_1.default)(app_1.default)
    ...
    `;
        const { rows } = yield connection_1.default.query(likesQuery);
        expect(rows).toBeInstanceOf(Array);
        expect(rows).toHaveLength(0);
    }));
    it("400: should respond with a msg if passed an invalid comment_id", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("403: should respond with a msg if the user tries to delete a comment they did not post", () => __awaiter(void 0, void 0, void 0, function* () {
        const { body: { msg }, } = yield (0, supertest_1.default)(app_1.default)
