...
const endpoints = {
    ...
    "POST /api/auth/login": {
        description: "Authenticates a user and generates an access token (valid for 15 minutes), requires a username and password in the request body. The response includes an access token and sets a refresh token (valid for 7 days) as an HTTP-only cookie",
        request: {
            body: {
                username: "Alex456",
        ...
        request: {
            ...
            body: {
                newQuiz: {
                    ...
                    category: "Exercise and Physical Activity",
                    description: "Test your knowledge about the importance of exercise and physical activity for overall health and well-being.",
                    username: "Mark@healthcareclinic.com",
                    quiz_img: "https://images.pexels.com/photos/2526878/pexels-photo-2526878.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
                    questions: [
                        {
                            question_text: "What are the recommended guidelines for aerobic exercise per week for adults?",
                            answers: [
                        ...
                        {
                            question_text: "Which type of exercise focuses on increasing flexibility and range of motion?",
                            answers: [
                        ...
                        {
                            question_text: "What are the potential benefits of regular physical activity?",
                            answers: [
                        ...
                        {
                            question_text: "How does exercise contribute to cardiovascular health?",
                            answers: [
                                {
                                ...
                                {
                                    answer_text: "It strengthens the heart, improves blood circulation, and lowers the risk of heart diseases",
                                    is_correct: true,
                                },
                                {
                        ...
                        {
                            question_text: "What is the role of strength training in an exercise routine?",
                            answers: [
                                {
                                ...
                                {
                                    answer_text: "It helps increase muscle strength, metabolism, and bone density",
                                    is_correct: true,
                                },
                                {
                        ...
                        {
                            question_text: "What is the recommended duration for cool-down exercises after a workout?",
                            answers: [
                        ...
                        {
                            question_text: "How can individuals overcome common barriers to exercise?",
                            answers: [
                                {
                                ...
                                {
                                    answer_text: "Stay consistent, set achievable goals, find enjoyable activities, and address time constraints",
                                    is_correct: true,
                                },
                                {
                        ...
                        },
                        {
                            ...
                            answers: [
                                ...
                                {
                                    answer_text: "No, it can decrease muscle strength before exercise",
                                    is_correct: true,
                                },
                                {
    ...
    "PATCH /api/quizzes/:quiz_id": {
        description: "Responds with the specified quiz and the updated likes value, set inc_likes to true to increase likes or false to decrease likes.",
        request: {
            method: "PATCH",
            path: "/api/quizzes/2",
            headers: {
    ...
    "PATCH /api/comments/:comment_id": {
        description: "Responds with the specified comment and with the updated likes value, set inc_likes to true to increase likes or false to decrease likes.",
        request: {
            method: "PATCH",
            path: "/api/comments/2",
            headers: {
