const endpoints = {
  ...
  "POST /api/auth/login": {
    description:
      "Authenticates a user and generates an access token, requires a username and password in the request body. The response includes an access token and sets a refresh token as an HTTP-only cookie",
    request: {
      body: {
        username: "Alex456",
        ...
        quizzes: [
          {
            ...
            description:
              "Test your knowledge of adventure travel destinations and activities with this trivia quiz.",
            username: "Alex456",
            user_id: 2,
  ...
  "POST /api/quizzes": {
    description:
      "Creates a new quiz by providing the necessary information. Each quiz should have 8 to 16 questions, each question must include 4 answer options with only one option being correct.",
    request: {
      headers: {
        Authorization: "Bearer <access_token_value>",
      },
      body: {
        newQuiz: {
          ...
          questions: [
            ...
            {
              question_text:
                "Which city is known for its famous Golden Gate Bridge?",
              answers: [
  ...
  "PATCH /api/quizzes/:quiz_id": {
    description:
      "Updates the likes value for the specified quiz, set inc_likes to true to increase likes or false to decrease likes.",
    request: {
      method: "PATCH",
      path: "/api/quizzes/2",
      headers: {
      ...
      response: {
        ...
        quiz: {
          ...
          description:
            "Put your knowledge of blockbuster movies to the test with this exciting quiz. From magical adventures to action.",
          quiz_img:
            "https://images.pexels.com/photos/1117132/pexels-photo-1117132.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
          category: "Movies",
          user_id: 1,
  ...
  "PATCH /api/comments/:comment_id": {
    description:
      "Updates the likes value for the specified comment, set inc_likes to true to increase likes or false to decrease likes.",
    request: {
      method: "PATCH",
      path: "/api/comments/2",
      headers: {
