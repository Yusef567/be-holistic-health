const firstMovieTriviaQuestions = [
  ...
  },
  {
    quiz_name: "First Movie Trivia",
    question_text:
      "Which movie features the line, I live my life a quarter mile at a time?",
  },
  {
    quiz_name: "First Movie Trivia",
    question_text:
      "In the Star Wars series, what is the name of the smuggler who pilots the Millennium Falcon?",
  },
  {
    quiz_name: "First Movie Trivia",
  ...
  },
  {
    quiz_name: "First Movie Trivia",
    question_text:
      "What is the name of the mystical ring in The Lord of the Rings series?",
  },
  {
    quiz_name: "First Movie Trivia",
    question_text:
      "Which character is known for saying, Why is the rum always gone?",
  },
  {
    quiz_name: "First Movie Trivia",
    question_text:
      "In the Fast and Furious series, what is the name of Dominic Toretto's sister?",
  },
  {
    quiz_name: "First Movie Trivia",
    question_text:
      "What is the name of the secret agent in the James Bond series?",
  },
];
...
const blockbusterMovieChallengeQuestions = [
  ...
  },
  {
    quiz_name: "Blockbuster Movie Challenge",
    question_text:
      "In which movie of the Fast and Furious franchise did Dwayne Johnson first appear?",
  },
  {
    quiz_name: "Blockbuster Movie Challenge",
    question_text:
      "What is the name of the iconic spaceship in the Star Wars series?",
  },
  {
    quiz_name: "Blockbuster Movie Challenge",
    question_text:
      "Who was the first actor to portray James Bond on the big screen?",
  },
  {
    quiz_name: "Blockbuster Movie Challenge",
    question_text:
      "What is the name of the wizard who possesses the One Ring in The Lord of the Rings series?",
  },
  {
    quiz_name: "Blockbuster Movie Challenge",
    question_text:
      "Who is the captain of the Black Pearl in the Pirates of the Caribbean series?",
  },
  {
    quiz_name: "Blockbuster Movie Challenge",
  ...
  },
  {
    quiz_name: "Blockbuster Movie Challenge",
    question_text:
      "Which actor played Dominic Toretto in the Fast and Furious series?",
  },
];
...
const adventureTravelTriviaQuestions = [
  {
    ...
    question_text:
      "Which country is known for its famous trekking route, the Inca Trail?",
  },
  {
    quiz_name: "Adventure Travel Trivia",
  ...
  },
  {
    quiz_name: "Adventure Travel Trivia",
    question_text:
      "Which African country is home to the world's largest desert?",
  },
  {
    quiz_name: "Adventure Travel Trivia",
    question_text:
      "Which city is renowned for its world-class surfing beaches?",
  },
  {
    quiz_name: "Adventure Travel Trivia",
    question_text:
      "What is the name of the famous hiking trail in the United States that spans over 2,000 miles?",
  },
  {
    quiz_name: "Adventure Travel Trivia",
    question_text:
      "Which country is famous for its thrilling bungee jumping experiences?",
  },
  {
    quiz_name: "Adventure Travel Trivia",
    question_text:
      "Which city is known as the 'Gateway to the Amazon Rainforest'?",
  },
  {
    quiz_name: "Adventure Travel Trivia",
    question_text:
      "What is the name of the iconic rock formation in Australia's Northern Territory?",
  },
];
...
const amazingScienceFactsTriviaQuestions = [
  ...
  },
  {
    quiz_name: "Amazing Science Facts Trivia",
    question_text:
      "What is the process of converting solid directly into vapor called?",
  },
  {
    quiz_name: "Amazing Science Facts Trivia",
...
const literaryMasterpiecesTriviaQuestions = [
  ...
  },
  {
    quiz_name: "Literary Masterpieces Trivia",
    question_text:
      "Which play by William Shakespeare features the character Hamlet?",
  },
  {
    quiz_name: "Literary Masterpieces Trivia",
  ...
  },
  {
    quiz_name: "Literary Masterpieces Trivia",
    question_text:
      "Which novel tells the story of the young wizard Harry Potter?",
  },
  {
    quiz_name: "Literary Masterpieces Trivia",
...
const classicLiteratureTriviaQuestions = [
  ...
  },
  {
    quiz_name: "Classic Literature Trivia",
    question_text:
      "Which novel by George Orwell depicts a dystopian society ruled by Big Brother?",
  },
  {
    quiz_name: "Classic Literature Trivia",
  ...
  },
  {
    quiz_name: "Classic Literature Trivia",
    question_text:
      "Which novel by J.R.R. Tolkien is set in the fictional world of Middle-earth?",
  },
];
...
const famousAuthorsTriviaQuestions = [
  ...
  },
  {
    quiz_name: "Famous Authors Trivia",
    question_text:
      "Which American author wrote the novel 'To Kill a Mockingbird'?",
  },
  {
    quiz_name: "Famous Authors Trivia",
  ...
  },
  {
    quiz_name: "Famous Authors Trivia",
    question_text:
      "Which British author wrote the 'Sherlock Holmes' detective stories?",
  },
  {
    quiz_name: "Famous Authors Trivia",
  ...
  },
  {
    quiz_name: "Famous Authors Trivia",
    question_text:
      "Which American author wrote the novel 'The Catcher in the Rye'?",
  },
];
...
const shakespeareanTriviaQuestions = [
  ...
  },
  {
    quiz_name: "Shakespearean Trivia",
    question_text:
      "In which play does the character Hamlet famously deliver the soliloquy that begins with 'To be, or not to be'?",
  },
  {
    quiz_name: "Shakespearean Trivia",
    question_text:
      "Which comedy by Shakespeare involves mistaken identities and a pair of twins named Antipholus?",
  },
  {
    quiz_name: "Shakespearean Trivia",
    question_text:
      "Who is the author of the romantic comedy 'A Midsummer Night's Dream'?",
  },
  {
    quiz_name: "Shakespearean Trivia",
    question_text:
      "Which play features the character of Lady Macbeth, known for her famous 'Out, damned spot!' monologue?",
  },
  {
    quiz_name: "Shakespearean Trivia",
    question_text:
      "In which play does the character Iago scheme against the title character, Othello?",
  },
  {
    quiz_name: "Shakespearean Trivia",
