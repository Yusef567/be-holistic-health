const ancientEgyptTriviaQuestions = [
  ...
  },
  {
    quiz_name: "Ancient Egypt Trivia",
    question_text:
      "What is the name of the famous female pharaoh who ruled Egypt for over two decades?",
  },
  {
    quiz_name: "Ancient Egypt Trivia",
  ...
  },
  {
    quiz_name: "Ancient Egypt Trivia",
    question_text:
      "What was the purpose of the mummification process in ancient Egypt?",
  },
  {
    quiz_name: "Ancient Egypt Trivia",
    question_text:
      "What is the name of the famous Egyptian queen who married Julius Caesar?",
  },
];
...
const ancientCivilizationsTriviaQuestions = [
  {
    ...
    question_text:
      "What was the name of the famous Roman building that was used for gladiatorial games and other public spectacles?",
  },
  {
    quiz_name: "Ancient Civilizations Trivia",
    question_text:
  ...
  },
  {
    quiz_name: "Ancient Civilizations Trivia",
    question_text:
      "What was the name of the system of government used in ancient Athens?",
  },
  {
    quiz_name: "Ancient Civilizations Trivia",
    question_text:
      "In ancient Rome, what was the name of the public square where citizens would gather for meetings and speeches?",
  },
  {
    quiz_name: "Ancient Civilizations Trivia",
...
const vikingsTriviaChallengeQuestions = [
  ...
  },
  {
    quiz_name: "Vikings Trivia Challenge",
    question_text:
      "What was the name of the Viking warrior who discovered Greenland?",
  },
  {
    quiz_name: "Vikings Trivia Challenge",
    question_text:
      "What was the name of the Viking who invaded and ruled England in the 11th century?",
  },
  {
    quiz_name: "Vikings Trivia Challenge",
...
const worldWarHistoryTriviaQuestions = [
  ...
  },
  {
    quiz_name: "World War History Trivia",
    question_text:
      "Where did Prime minister Winston Churchill suggest that the royal family should move to during the war?",
  },
  {
    quiz_name: "World War History Trivia",
  ...
  },
  {
    quiz_name: "World War History Trivia",
    question_text:
      "What was the nickname given to the German airship, the LZ 129 Hindenburg?",
  },
  {
    quiz_name: "World War History Trivia",
    question_text:
      "What was the code name for the atomic bomb program during World War II?",
  },
  {
    quiz_name: "World War History Trivia",
    question_text:
      "Which country was not a member of the League of Nations during the interwar period?",
  },
];
...
const geographyGeniusQuizQuestions = [
  ...
  },
  {
    quiz_name: "Geography Genius Quiz",
    question_text:
      "Which European country is divided into 17 autonomous regions, including Catalonia and Basque?",
  },
  {
    quiz_name: "Geography Genius Quiz",
    question_text:
      "Which country is both the smallest and the most densely populated country in Central America?",
  },
  {
    quiz_name: "Geography Genius Quiz",
  ...
  },
  {
    quiz_name: "Geography Genius Quiz",
    question_text:
      "Which country is located at the southernmost point of the African continent?",
  },
  {
    quiz_name: "Geography Genius Quiz",
...
const worldCupWonderQuizQuestions = [
  ...
  },
  {
    quiz_name: "World Cup Wonder Quiz",
    question_text:
      "In tennis, which tournament is considered the most prestigious of all?",
  },
  {
    quiz_name: "World Cup Wonder Quiz",
...
const famousCharactersAndMoviesTriviaQuestions = [
  {
    ...
    question_text:
      "Who played the character of Gandalf in the Lord of the Rings trilogy?",
  },
  {
    quiz_name: "Famous Characters and Movies Trivia",
    question_text:
      "Which famous actor played the role of Walter White in the TV series Breaking Bad?",
  },
  {
    quiz_name: "Famous Characters and Movies Trivia",
  ...
  },
  {
    quiz_name: "Famous Characters and Movies Trivia",
    question_text:
      "What is the name of the prison guarded by the Dementors in the Harry Potter series?",
  },
  {
    quiz_name: "Famous Characters and Movies Trivia",
    question_text:
      "What is the name of the hobbit who is entrusted with carrying the One Ring to Mordor?",
  },
  {
    quiz_name: "Famous Characters and Movies Trivia",
    question_text:
      "What is the name of the three-headed dog who guards the Philosopher's Stone in the first Harry Potter book?",
  },
];
...
const lightsCameraActionQuestions = [
  {
    ...
    question_text:
      "What is the name of the ring that Frodo must destroy in The Lord of the Rings?",
  },
  {
    quiz_name: "Lights, Camera, Action",
  ...
  },
  {
    quiz_name: "Lights, Camera, Action",
    question_text:
      "What is the name of the character played by Vin Diesel in the Fast and Furious franchise?",
  },
  {
    quiz_name: "Lights, Camera, Action",
    question_text:
      "What is the name of the wizard who mentors Frodo in The Lord of the Rings?",
  },
  {
    quiz_name: "Lights, Camera, Action",
    question_text:
  ...
  },
  {
    quiz_name: "Lights, Camera, Action",
    question_text:
      "In Star Wars: A New Hope, what is the name of the planet that the Death Star destroys?",
  },
  {
    quiz_name: "Lights, Camera, Action",
    question_text:
      "What is the name of the magical sport played in the Harry Potter series?",
  },
  {
    quiz_name: "Lights, Camera, Action",
    question_text:
      "What is the name of the hobbit who carries the One Ring in the Lord of the Rings trilogy?",
  },
];
