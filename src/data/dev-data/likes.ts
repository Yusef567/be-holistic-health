...
for (let contentId = 1; contentId < 5; contentId++) {
  likesData.push(
    { content_id: contentId, content_type: "quiz", user_id: 1, like_value: 1 },
    { content_id: contentId, content_type: "quiz", user_id: 2, like_value: 1 },
    { content_id: contentId, content_type: "quiz", user_id: 3, like_value: 1 }
  );
}
